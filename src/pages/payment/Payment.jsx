    ...
    return (
            <div className="main-content">
                ...
                <div className="programsCard">
                    {cards.map(item=>
                    (item.card).map(i=>
                    <div key={i.key} className='programsCard-blocks' onClick={()=>{setMenuState(i.key)}}>
                        ...
                        {menuState==i.key?
                            <div className="programsCard-blocks-information">
                                ...
                                {/* <button onClick={(e) => {e.preventDefault(); window.open('https://forms.yandex.ru/u/66929916e010db42c3ad85f0/')}}>Оплатить</button> */}
                                <form className="yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8" >
                                    ...
                                    <input name="shopId" type="hidden" value="418580"/>
                                </form>
