            ...
            <div className="main-content">
                <div className="main any-page"><Header/></div>
                    <div className="container doc-style">
                        <p className="doc-title">Политика обработки персональных данных</p><br/>
                        <br/>
                        1. Общие положения
                        Использование сервисов веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a> означает безоговорочное согласие Пользователя с&nbsp;настоящей Политикой обработки персональных данных (далее&nbsp;&mdash; Политика) и&nbsp;указанными в&nbsp;ней условиями обработки его персональных данных; в&nbsp;случае несогласия с&nbsp;этими условиями Пользователь должен воздержаться от&nbsp;использования сервисов.<br/>
                        <br/>
                        ...
                        1.2. Настоящая Политика Оператора применяется ко&nbsp;всей информации, которую Оператор может получить о&nbsp;посетителях веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a>.
                        1.3. Оператор не&nbsp;контролирует и&nbsp;не&nbsp;несет ответственности за&nbsp;сайты третьих лиц, на&nbsp;которые Пользователь может перейти по&nbsp;ссылкам, доступным на&nbsp;веб-сайте <a href="https://baruzdin.online">https://baruzdin.online</a>.<br/>
                        <br/>
                        ...
                        2.3. Веб-сайт&nbsp;&mdash; совокупность графических и&nbsp;информационных материалов, а&nbsp;также программ для ЭВМ и&nbsp;баз данных, обеспечивающих их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <a href="https://baruzdin.online">https://baruzdin.online</a>.<br/>
                        ...
                        2.8. Персональные данные&nbsp;&mdash; любая информация, относящаяся прямо или косвенно к&nbsp;определенному или определяемому Пользователю веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a>.<br/>
                        ...
                        2.10. Пользователь&nbsp;&mdash; любой посетитель веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a>.
                        ...
                        <br/>
                        3. Предмет политики обработки персональных данных<br/>
                        3.1. Настоящая Политика устанавливает обязательства Оператора по&nbsp;неразглашению и&nbsp;обеспечению режима защиты конфиденциальности персональных данных, которые Пользователь предоставляет Оператору при заполнении специальной формы (анкеты) на&nbsp;веб-сайте <a href="https://baruzdin.online">https://baruzdin.online</a>, через которую Пользователь направляет запрос на&nbsp;получение обратной связи от&nbsp;Оператора по&nbsp;вопросу предоставления услуги. <br/>
                        ...
                        <br/>
                        4. Цели сбора персональных данных Пользователя<br/>
                        ...
                        4.2.1. Предоставление Пользователю доступа к&nbsp;персонализированным ресурсам веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a>.<br/>
                        4.2.2. Установление с&nbsp;Пользователем обратной связи, включая направление уведомлений, запросов, в&nbsp;том числе касающихся использования веб-сайта <a href="https://baruzdin.online">https://baruzdin.online</a>, оказание услуг, обработку запросов и&nbsp;заявок от&nbsp;Пользователя. <br/>
                        ...
                        <br/>
                        5. Условия обработки персональных данных Пользователей и&nbsp;их&nbsp;передачи третьим лицам<br/>
                        ...
                        <br/>
                        6. Основные права и&nbsp;обязанности Оператора<br/>
                        ...
                        <br/>
                        7. Основные права и&nbsp;обязанности субъектов персональных данных<br/>
                        ...
                        8.1. До&nbsp;обращения в&nbsp;суд с&nbsp;иском по&nbsp;спорам, возникающим из&nbsp;отношений между Пользователем веб-сайта <a>https://baruzdin.online</a> и&nbsp;Оператором, обязательным является предъявление претензии (письменного предложения о&nbsp;добровольном урегулировании спора). <br/>
                        ...
                        9.5. Актуальная версия Политики размещена в&nbsp;свободном доступе в&nbsp;сети Интернет по&nbsp;адресу <a>https://baruzdin.online/privacy</a>/.<br/>               
                    </div>
            </div>
            <Footer/>
        </div>
